...
public class VendasSimples extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jc_forma_pag.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "DINHEIRO", "CARTÃO" }));
    ...
    private void bt_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_excluirActionPerformed
        try{
            String sql = "select * from vendas where nota="+jt_numNota.getText()+" and cod_produto='"+jt_codProduto.getText()+"'";
            ...
            if(opcao_escolhida == JOptionPane.YES_OPTION){
                ...
                sql = "delete from vendas where nota="+jt_numNota.getText()+" and cod_produto='"+jt_codProduto.getText()+"'";
                 ...
                 if(con_crediario.resultSet.next()){
                   ...
                   con_crediario.statement.executeUpdate(sqlcrediario);
                    ...
                    con_venda.executeSQL("select * from vendas where nota="+jt_numNota.getText()+"");
                    con_venda.resultSet.first();
                    preecher_Jtable();
                    jt_codProduto.setText("");
                    jt_nomeProd.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendasSimples.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendasSimples().setVisible(true);
            }
        });
    }
 ...
 public void atualiza_combox_cliente(){
    ...
    public void atualizaValorVendaDesconto(){
        String sql = "select * from vendas where nota="+jt_numNota.getText()+"";
        con_venda.executeSQL(sql);
        try {
            con_venda.resultSet.first();
             while (con_venda.resultSet.next()) {
                ...
                String sqlDesconto = "update vendas set total_compra="+total+" where nota="+jt_numNota.getText()+"";
           JOptionPane.showMessageDialog(null,"sql="+sql);
    ...
    public void adicionar(){
      ...
      //jc_comboClientes.setSelectedItem("nulo");
        ...
        try {       
            String sql;
                  sql = "insert into vendas(nota,cod_cliente,cliente,cod_produto,nome,valor_unit,quantidade,total_compra,data,valor_receb,troco,forma_pagamento,data_venc) values("+
